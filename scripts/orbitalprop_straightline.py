...
from Functions.initial_conditions import build_swarm_initial_state_optimized_oe
from Functions.postprocess import extract_time_arrays, extract_rv, rv_to_kepler
from Functions.plotting import (
    plot_eci_3d, plot_osculating_oe,
    plot_relative_lvlh, plot_relative_lvlh_components, plot_swarm_dispersion, plot_swarm_dispersion_LVLH,
...
for name, info in zip(deputy_names, opt_results):
    print(f"{name}")
